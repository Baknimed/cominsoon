...
$router->group([
    ...
    $router->get('/places/{city_id}', 'Admin\PlaceController@getListByCity')->name('place_get_list');
    ...
    $router->put('/transports/availability', 'Admin\TransportController@updateAvailability')->name('transport_update_availability');
