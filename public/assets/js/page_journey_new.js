(function ($) {
        ...
        if (social_item < 9) {
            ...
            <div class="field-inline field-3col social_item">
                            ...
                            <div class="field-group field-select">
                                <label for="place_socials">Place</label>
                    ...
                    <i class="la la-trash-alt"></i>
                        ...
                        <div class="field-inline field-3col social_item">
                            ...
                            <div class="field-group field-select">
                                <label for="place_socials">Place</label>
                                <select name="city_id" class="custom-select" id="select_city" type="date" required>
    ...
    $("#select_city").change(function () {
        ...
        let select_place = $("#select_place");
        let data_resp = callAPI({
            url: getUrlAPI(`${app_url}/places/${city_id}`, "full"),
            method: "GET",
        });
        data_resp.then((res) => {
            let html = "";
            ...
            select_place.find("option").remove();
            select_place.append(html);
        });
    });
    /**
     * Upload gallery
