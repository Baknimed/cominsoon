...
class TransportController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $transports = $this->transport->listByFilter($param_country_id, $param_city_id, $param_cat_id);
        $countries = $this->country->getFullList();
        $cities = $this->city->getListByCountry($param_country_id);
        $categories = $this->category->getListAll(Category::TYPE_TRANSPORT);

        //        return $places;

        return view('admin.transport.transport_list', [
    ...
    public function createView(Request $request)
    {
        ...
        $country_id = $transport ? $transport->country_id : false;
        ...
        $tfeatures = $this->tfeatures->getListAll();

        //        return $place;

        return view('admin.transport.transport_create', compact('countries', 'cities', 'categories', 'place_types', 'tfeatures', 'transport'));
    }
    ...
    public function updateAvailability(Request $request)
    {
        ...
        $model = Transport::find($request->transport_id);
        $model->fill($data)->save();
