                                ...
                                <div class="popup popup--left">
                                    ...
                                    <div class="popup__button popup__box">
                                        <a class="btn" href="{{route('place_addnew')}}">
                                            ...
                                            <span>{{__('Plan your journey')}}</span>
                                        </a>
                                    </div><!-- .popup__button -->
                                </div><!-- .popup -->
                            </div><!-- .site__menu -->
                    ...
                    <div class="col-md-9 col-4">
                        <div class="right-header align-right">
                            ...
                            <div class="right-header__login">
                                <a class="{{isActiveMenu('transport')}}" href="{{route('transport')}}">{{__('Transportation')}}</a>
                            </div>
                            <div class="right-header__login">
                                <a href="{{route('event_list_all')}}">{{__('Events')}}</a>
                            </div>
                            <div class="right-header__login">
                                <a href="{{route('post_list_all')}}">{{__('Blog')}}</a>
                            </div>
                            <div class="right-header__login">
                                <a href="{{route('stores')}}">{{__('Shop')}}</a>
                            </div>
                            ...
                            <div class="account">
                                ...
                                <div class="account-sub">
                                    <ul>
                                        ...
                                        @endif
                                        <li class="{{isActiveMenu('user_profile')}}"><a href="{{route('user_profile')}}"><i class="la la-user-circle la-24"></i>{{__('Profile')}}</a></li>
                                        <li class="{{isActiveMenu('user_my_place')}}"><a href="{{route('user_my_place')}}"><i class="la la-check-double la-24"></i>{{__('Orders')}}</a></li>
                                        <li class="{{isActiveMenu('user_my_place')}}"><a href="{{route('user_my_place')}}"><i class="la la-list la-24"></i>{{__('My Places')}}</a></li>
                                        <li class="{{isActiveMenu('user_wishlist')}}"><a href="{{route('user_wishlist')}}"><i class="la la-bookmark la-24"></i>{{__('Wishlist')}}</a></li>
                                        <li>
                                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="la la-sign-out la-24"></i>{{__('Logout')}}</a>
                                            <form class="d-none" id="logout-form" action="{{ route('logout') }}" method="POST">
                                                @csrf
                                            </form>
                                        </li>
                            ...
                            @endguest
                            <div class="right-header__login">
                                <a href="{{route('stores')}}"><i class="la la-shopping-cart la-24"></i></a>
                            </div>
                            <div class="right-header__button btn">
                                <a title="Add place" href="{{route('journey_plan')}}">
                                    <i class="la la-plus la-24"></i>
                                    <span>{{__('Plan your journey')}}</span>
                                </a>
                            </div>
        ...
        <footer id="footer" class="footer">
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <aside class="footer__top__nav footer__top__nav--contact">
                                <h3>{{__('Contact Us')}}</h3>
                                <p>{{__('Email: support@thealchemisttravels.com')}}</p>
                                <p>{{__('Phone: +212 6 4154 0378')}}</p>
                                <ul>
                                    <li>
                ...
                <div class="footer__bottom">
                    <p class="footer__bottom__copyright">{{now()->year}} &copy; <a href="/" target="_blank">{{__('TheAlchemistTravels')}}</a>. {{__('All rights reserved.')}}</p>
                </div><!-- .top-footer -->
            </div><!-- .container -->
        </footer><!-- site-footer -->
    </div><!-- #wrapper -->
